...
exports.UsersPaymentsProvider = void 0;
const common_1 = require("@nestjs/common");
const client_1 = require("../client");
let UsersPaymentsProvider = class UsersPaymentsProvider {
    constructor(client) {
        this.client = client;
    }
    api(path, params) {
...
UsersPaymentsProvider = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [client_1.UsersClient])
], UsersPaymentsProvider);
exports.UsersPaymentsProvider = UsersPaymentsProvider;
